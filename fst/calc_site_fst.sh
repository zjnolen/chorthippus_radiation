#!/bin/bash
#SBATCH -J calc_site_fst
#SBATCH --output=calc_site_fst.out
...
for pair in "cbig_b_cbru_b" "cbig_b_cbru_s" "cbig_e_cbru_b" "cbig_e_cbru_s" "cmol_b_cbru_b" "cmol_b_cbru_s" "cmol_e_cbru_b" "cmol_e_cbru_s" "cmol_e_cbig_e" "cmol_b_cbig_b" "cmol_e_cbig_b" "cmol_b_cbig_e"
	...
	do
		...
		echo "Calculating site Fst from global Fst file for the following taxa: ${first} and ${second}"


		realSFS fst print fst/glob_${first}_${second}_p1_fold0.fst.idx > fst/site_${first}_${second}_p1_fold0.fst
